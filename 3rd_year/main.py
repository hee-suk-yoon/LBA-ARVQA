...
def main(args):
    ...
    for idx, question in enumerate(tqdm(test_questions)):
        ...
        with torch.no_grad():
            ...
            # save the json list 
            utils_sys.write_json(output_list, os.path.join(args.output_dir, 'output_KAIST.json'))
    return
if __name__ =="__main__":
    ...
    parser.add_argument('--model_ckpt', type=str, default='/mnt/hsyoon/workspace/LBA-ARVQA/saves/ckpt/2023-10-30_15:13:30_best_loss.pt')
    parser.add_argument('--classifier_ckpt', type=str, default='/mnt/hsyoon/workspace/LBA-ARVQA/saves/ckpt/2023-10-30_15:13:30_classifier_best_loss.pt')
